...
<div id = "content_wide">
  <div class = "thin">
<?
drawArgumentBoxExtended($sPage->getQuestion(), $sPage->getView(), $sPage->basePath(), $sPage->getArgument()->parent(), true, true, true, $sPage->getArgument());

echo "<div class = 'argument_container_full'>";
